...
type I_Rero_Users interface {
	...
	ChangePassword(username string, newPassword *models.UserChangePassword) error
...
func (ru *repo_user) ChangePassword(username string, newPassword *models.UserChangePassword) error {
	// find date  before
	...
	// update new data
	dataFind.HashedPassword = newPassword.Password
